      ...
      <div className="resume" style={{ fontFamily: this.props.fontFamily }}>
        <div className="info">
          ...
          <div className="main-info">
            <h1
              style={{ color: this.props.primary, textTransform: "capitalize" }}
            >
              {this.props.name}
            </h1>
          ...
          <div className="extrainfo">
            ...
            {this.props.address === "" ? null : (
              <a href={this.props.address}>
                {" "}
                <LocationOnIcon style={{ color: this.props.primary }} />{" "}
                {this.props.address}
              </a>
            )}
        ...
        <div className="section">
          <div className="left-section">
              ...
              <div className="experiences">
                ...
                {this.props.exp.postname === "" ? null : (
                  <div className="div">
                    ...
                    >
                      {this.props.exp.from}{" "}
                      {this.props.exp.to && `- ${this.props.exp.to}`}
                    </p>
                ...
                {this.props.exp2.postname === "" ? null : (
                  <div className="div">
                    <h2
                      style={{ fontSize: "1rem", color: this.props.secondary }}
                    >
                      {this.props.exp2.postname}
                    </h2>
                    <h2 style={{ fontSize: "1rem", fontWeight: "400" }}>
                    ...
                    <p
                      ...
                      className="fromto"
                    >
                      {this.props.exp2.from}{" "}
                      {this.props.exp2.to && `- ${this.props.exp2.to}`}
                    </p>
                    <h5 style={{ fontWeight: "400" }}>Experience:</h5>
                ...
                {this.props.exp3.postname === "" ? null : (
                  <div className="div">
                    ...
                    <p
                      ...
                      className="fromto"
                    >
                      {this.props.exp3.from}{" "}
                      {this.props.exp3.to && `- ${this.props.exp3.to}`}
                    </p>
                    <h5 style={{ fontWeight: "400" }}>Experience:</h5>
                ...
                {this.props.exp4.postname === "" ? null : (
                  <div className="div">
                    ...
                    <p
                      ...
                      className="fromto"
                    >
                      {this.props.exp4.from}{" "}
                      {this.props.exp4.to && `- ${this.props.exp4.to}`}
                    </p>
                    <h5 style={{ fontWeight: "400" }}>Experience:</h5>
                    <p style={{}}>- {this.props.exp4.expdesc}</p>
                  </div>
                )}
                {this.props.exp5.postname === "" ? null : (
                  <div className="div">
                    <h2
                      style={{ fontSize: "1rem", color: this.props.secondary }}
                    >
                    ...
                    <p
                      ...
                      className="fromto"
                    >
                      {this.props.exp5.from}{" "}
                      {this.props.exp5.to && `- ${this.props.exp5.to}`}
                    </p>
                    <h5 style={{ fontWeight: "400" }}>Experience:</h5>
                ...
                {this.props.exp6.postname === "" ? null : (
                  <div className="div">
                    <h2
                      style={{ fontSize: "1rem", color: this.props.secondary }}
                    >
                      {this.props.exp6.postname}
                    </h2>
                    <h2 style={{ fontSize: "1rem", fontWeight: "400" }}>
                      {this.props.exp6.company}
                    </h2>
                    <p
                      style={{
                        fontSize: "13px",
                      ...
                      className="fromto"
                    >
                      {this.props.exp6.from}{" "}
                      {this.props.exp6.to && `- ${this.props.exp6.to}`}
                    </p>
                    <h5 style={{ fontWeight: "400", marginTop: "2px" }}>
                      Experience:
                    </h5>
            ...
            {Object.keys(this.props.edu).reduce((flag, education) => {
              if (
                ...
                this.props.edu[education].school !== "" &&
                !flag
              ) {
                return (
                ...
                if (
                  ...
                  return (
                    <div className="div">
                      ...
                      <h2 style={{ fontSize: "1rem", fontWeight: "400" }}>
                        {this.props.edu[education].course}
                      </h2>
                      <p
                        style={{
                          fontSize: "13px",
          ...
          <div className="right-section">
            {this.props.skills.length === 0 ? null : (
                  ...
                  {this.props.skills.map((item) => {
                    if (item.length > 0) {
                      return (
                        <p
                          className="skill"
                          style={{ backgroundColor: this.props.secondary }}
                        >
                          {item}
                        </p>
                      );
            ...
            {this.props.project3.name === "" &&
            this.props.project2.name === "" &&
            this.props.project.name === "" ? null : (
              <div className="projects">
                ...
                {this.props.project.name === "" ? null : (
                  <div className="div" style={{ marginBottom: "1rem" }}>
                    <div
                      style={{
                        display: "flex",
                        flexWrap: "wrap",
                    ...
                    >
                      ...
                      {this.props.project.link === "" ? null : (
                        ...
                        >
                          <AttachmentIcon
                            style={{ color: this.props.secondary }}
                          />
                        </a>
                      )}
                    </div>
                ...
                {this.props.project4.name === "" ? null : (
                  <div className="div" style={{ marginBottom: "1rem" }}>
                    ...
                    >
                      <h2 style={{ fontSize: "1rem" }}>
                        {this.props.project4.name}
                      </h2>
                      {this.props.project4.link === "" ? null : (
                        <a
                          href={this.props.project4.link}
                          style={{ fontSize: "1rem", fontWeight: "400" }}
                          className="attachments"
                        >
                          <AttachmentIcon
            ...
            {this.props.achlist.length === 0 ? null : (
              <div className="achiec">
                <h2
                  className="section-heading"
                  style={{ color: this.props.primary }}
                >
