  ...
  return (
    <div id="main">
      <header className="header">
        <h2><pre>      </pre></h2>
        <h1>
          📄<span>Resume Cooker </span>{" "}
        </h1>
        <div className="right">
          <a href="https://github.com/nitinryali/Resume-cooker">
            Github
          </a>
          <a href="https://drive.google.com/file/d/1SYf9s_zoyEs9z641NfjXJ7wIx4rCTxpU/view?usp=drive_link" target="_blank">
            My Resume
          </a>
        </div>
      </header>
      ...
      <footer className="footer">
        <p>Made with ❤️ by @Nitin ryali</p>
      </footer>
    </div>
  );
}
